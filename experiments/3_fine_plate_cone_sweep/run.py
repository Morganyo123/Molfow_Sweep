...
#0 to 2cm plate positions
#cone -0.25 to 0.25 cm relative to plate position
...
for i in range(0,11):
    ...
    for j in range(0,6):
        ...
        plate_off = 0.2*i #steps of 0.2 cm for the plate
        ...
        cone_off = plate_off + 0.1*j -0.25 

        plate_off = round(plate_off, 2)
        cone_off = round(cone_off, 2)
        
        print(f"Plate offset: {plate_off}, Cone offset: {cone_off}")
