...
PLATE = ["plate_front", "plate_back"] #plate has now got 0.8 opacity, to model a mesh that lets some particles through, but not all. 
...
cfg = SweepConfig(
    ...
    base_geometry="geometries\simplified_target_baseplate_cone_meshplate.xml",
